...
class Ecu_Fadec : Ecu {
  private:
    ...
    SimpleSPortSensor sensorEGT = SimpleSPortSensor(0x0400);
    SimpleSPortSensor sensorRPM = SimpleSPortSensor(0x0500);
    SimpleSPortSensor sensorCurrent = SimpleSPortSensor(0x0200);
    SimpleSPortSensor sensorBattVoltage = SimpleSPortSensor(0x0210);
    SimpleSPortSensor sensorPumpVoltage = SimpleSPortSensor(0x0211);
